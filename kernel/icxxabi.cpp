...
// I cannot find the author of most of the below functions, I know they work so thank you anonymous author :)
// If you know who it is, please message me @prasoc and I will give credit

// This hunk of code allows the program to implicitly understand what constructors and destructors are, and call them
// when we need objects initialised. This is a C++ only feature, as C doesn't have classes

// Further augmentation is needed to fully map all of the features of C++. I will update this file as needed.

// extern "C" {

//     void __cxa_pure_virtual() { } // Allows us to use pure virtual functions
